...
class MainWindow(QMainWindow):
    ...
    def _build_left_panel(self) -> QWidget:
        ...
        self.indicator_list.horizontalHeader().setSectionResizeMode(0, QHeaderView.Interactive)
        self.indicator_list.horizontalHeader().setSectionResizeMode(1, QHeaderView.Interactive)
        self.indicator_list.setColumnWidth(0, 58)
